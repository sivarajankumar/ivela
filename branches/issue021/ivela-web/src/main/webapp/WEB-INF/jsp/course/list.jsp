...
<div id="col-1-courses"> 
    ...
    <p class="page-courses"><span class="courses-listed"><s:property value="%{page > 1? pageSize * (page - 1) : (page / 1)}" /> <s:text name="front.to" />   <s:property value="%{page > 1? (pageSize * (page - 1)) + courseList.size() : courseList.size()}" /> <s:text name="front.of" /> <s:property value="count" /> <s:text name="front.courses" /> </span></p>
