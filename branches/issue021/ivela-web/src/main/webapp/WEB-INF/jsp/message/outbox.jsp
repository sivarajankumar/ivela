...
<html>
    ...
    <div id="col-2-messages">
        <h2><s:text name="message.sentMessages" /></h2>
        
        <jsp:include page="paginator.jsp"/>

        <div id="box-search">
            <h3><s:text name="message.search"/></h3>
            <s:form theme="simple" action="message!searchOutbox" cssClass="form-system-message">
        ...
        <table class="table-message">
            <tr>
                ...
                <th><s:text name="message.list.recipient" /></th>
                <th><s:text name="message.list.datetime" /></th>
            </tr>
            <s:iterator value="messageList">
                <s:url id="listMessage" action="message" method="getOutbox">
                ...
                <tr>
                    ...
                    <td class="author"><s:a href="%{listMessage}"><s:property value="recipient.username" /></s:a></td>
