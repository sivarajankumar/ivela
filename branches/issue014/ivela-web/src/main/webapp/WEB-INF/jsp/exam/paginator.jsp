    ...
    <s:if test="pageCount > 1"> 
        <s:if test="page == 1 && pageCount >= 3">
            <s:iterator status="stat" value="{page, (page + 1), (page + 2)}" id="it" > 
                ...
                <s:if test="#it == page + 1">
                    <a class="naveg-question" href="#" onclick="javascript:test('<s:property value="page + 1"/>');" ><s:text name="message.paginator.next" /></a>
                </s:if>
            </s:iterator>
        </s:if>
        ...
        <s:if test="page == pageCount">
            <a class="naveg-question" href="#" onclick="javascript:test('<s:property value="page + 1"/>');" ><s:text name="" /><s:text name="" /></a>     
        </s:if>
