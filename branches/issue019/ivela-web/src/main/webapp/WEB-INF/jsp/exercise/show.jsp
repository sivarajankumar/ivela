...
<html>
    <head>
        ...
        <title><s:text name="exercise.show.pageTitle" /></title>
    ...
    <s:form id="questionForm" method="get" action="exercise!saveResultQuestion.action">
        ...
        <s:hidden id="exercise_id" value="%{exercise.id}" name="exercise.id"/> 
        <s:hidden id="unitContent_id" value="%{unitContent.id}" name="unitContent.id"/> 
        <s:hidden id="answerStudentExerciseId" value="%{answerStudentExerciseId}" name="answerStudentExerciseId"/>
        <h1><s:text name="exercise.show.name" /> </h1>
        <s:if test="result==null">
            ...
            <table class="table-exercises-result" width="568" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="368" class="titulo"><s:text name="exercise.show.question" /></td>
                    <td width="368" class="titulo"><s:text name="exercise.show.score" /></td>
                </tr>
                
                
                <s:iterator value="result" status="count">
                    <tr>
                        <td class="score"><s:property value="%{(#count.index) +1}" /></td>
                        <td class="score"> <s:property /></td>
                    </tr>
