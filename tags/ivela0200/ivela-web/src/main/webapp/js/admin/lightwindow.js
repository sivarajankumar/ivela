...
lightwindow.prototype = {
                            ...
                            skin : {
                                ...
                                gallery : {
                                    top : '<div class="lightwindow_galleries_list">'
                                            ...
                                            + "<ul>",
                                    middle : "<li>" + "{gallery_link_replace}"
                                            + "</li>",
                                    bottom : "</ul>" + "</div>"
                                }
                            },
    ...
    _prepareIE : function(c) {
        if (Prototype.Browser.IE) {
            ...
            var h = previousIEheight = document.body.currentStyle.height;
    ...
    _displayLightWindow : function(b, a) {      
        $("lightwindow_overlay").style.height = this.pageDimensions.height + "px";      
