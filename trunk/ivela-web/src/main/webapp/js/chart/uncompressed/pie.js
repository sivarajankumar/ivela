...
function pie()
{
 ...
 this.render = function(canvas, title, colorArray)
  {
   ...
   for(i = 0; i<this.data.length; i++)
      {
       ...
       mxa = (mx < 0 ? 50 : 0);
       jg.setColor("black");
       jg.drawString(this.x_name[i]+"<table><tr><td bgcolor='white'><b>("+pc+"%"+")</b></td></tr></table>",sx+mx-mxa,sy-my);
      }
