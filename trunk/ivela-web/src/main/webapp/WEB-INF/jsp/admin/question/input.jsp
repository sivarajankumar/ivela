...
<%@ taglib prefix="s" uri="/struts-tags" %>
    ...
    <s:form name="formUpload" id="formQuestionAddFile" action="question!addQuestionText.action" method="post" enctype="multipart/form-data">
        <s:hidden name="questionText.text" value=""/>
        <s:hidden name="question.id" value=""/>
        <s:hidden name="unit.id" value=""/>
        <s:hidden name="unitContent.id" value=""/>
        <s:hidden name="atividade" value=""/>
        <s:hidden name="exercise.id" value=""/>
        <s:hidden name="exam.id" value=""/>
        <h2><s:text name="question.input.audioQuestion" /></h2><br />
        <s:file id="id" name="fileQuestion" theme="simple" value=""/>
    </s:form>
    ...
    <s:form action="question!add.action" method="post" enctype="multipart/form-data">
