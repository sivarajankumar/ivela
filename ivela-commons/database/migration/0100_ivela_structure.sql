...
--
-- Name: country; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--
...
ALTER TABLE ivela.country OWNER TO ivela;
...
--
-- Name: ethnicity; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--
...
ALTER TABLE ivela.ethnicity OWNER TO ivela;
...
--
-- Name: honorific; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--
...
ALTER TABLE ivela.honorific OWNER TO ivela;
...
--
-- Name: language_internationalization; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--

CREATE TABLE language_internationalization (
    id numeric(10,0) NOT NULL,
    language integer NOT NULL
);


ALTER TABLE ivela.language_internationalization OWNER TO ivela;
...
--
-- Name: location_type; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--
...
ALTER TABLE ivela.location_type OWNER TO ivela;
...
--
-- Name: sq_country; Type: SEQUENCE; Schema: ivela; Owner: ivela
--
...
ALTER TABLE ivela.sq_country OWNER TO ivela;

--
-- Name: sq_country; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_country OWNED BY country.id;
...
--
-- Name: sq_ethnicity; Type: SEQUENCE; Schema: ivela; Owner: ivela
--

CREATE SEQUENCE sq_ethnicity
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER TABLE ivela.sq_ethnicity OWNER TO ivela;

--
-- Name: sq_ethnicity; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_ethnicity OWNED BY ethnicity.id;
...
--
-- Name: sq_honorific; Type: SEQUENCE; Schema: ivela; Owner: ivela
--

CREATE SEQUENCE sq_honorific
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER TABLE ivela.sq_honorific OWNER TO ivela;

--
-- Name: sq_honorific; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_honorific OWNED BY honorific.id;
...
--
-- Name: sq_language_internationalization; Type: SEQUENCE; Schema: ivela; Owner: ivela
--

CREATE SEQUENCE sq_language_internationalization
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER TABLE ivela.sq_language_internationalization OWNER TO ivela;

--
-- Name: sq_language_internationalization; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_language_internationalization OWNED BY language_internationalization.id;
...
--
-- Name: sq_location_type; Type: SEQUENCE; Schema: ivela; Owner: ivela
--

CREATE SEQUENCE sq_location_type
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
    CACHE 1;
...
ALTER TABLE ivela.sq_location_type OWNER TO ivela;

--
-- Name: sq_location_type; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_location_type OWNED BY location_type.id;
...
--
-- Name: state; Type: TABLE; Schema: ivela; Owner: ivela; Tablespace: 
--

CREATE TABLE state (
    id numeric(10,0) NOT NULL,
    country numeric(10,0) NOT NULL,
    name character varying(100)
);


ALTER TABLE ivela.state OWNER TO ivela;

--
-- Name: sq_state; Type: SEQUENCE; Schema: ivela; Owner: ivela
--
...
ALTER TABLE ivela.sq_state OWNER TO ivela;

--
-- Name: sq_state; Type: SEQUENCE OWNED BY; Schema: ivela; Owner: ivela
--

ALTER SEQUENCE sq_state OWNED BY state.id;
...
ALTER TABLE country ALTER COLUMN id SET DEFAULT nextval('sq_country'::regclass);
...
ALTER TABLE ethnicity ALTER COLUMN id SET DEFAULT nextval('sq_ethnicity'::regclass);
...
ALTER TABLE honorific ALTER COLUMN id SET DEFAULT nextval('sq_honorific'::regclass);
...
ALTER TABLE language_internationalization ALTER COLUMN id SET DEFAULT nextval('sq_language_internationalization'::regclass);
...
ALTER TABLE location_type ALTER COLUMN id SET DEFAULT nextval('sq_location_type'::regclass);
...
ALTER TABLE state ALTER COLUMN id SET DEFAULT nextval('sq_state'::regclass);
...
--
-- Name: country_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--
...
--
-- Name: ethnicity_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--
...
--
-- Name: honorific_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--

ALTER TABLE ONLY honorific
    ADD CONSTRAINT honorific_pk PRIMARY KEY (id);


--
-- Name: language_internationalization_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--

ALTER TABLE ONLY language_internationalization
    ADD CONSTRAINT language_internationalization_pk PRIMARY KEY (id);


--
-- Name: location_type_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--
...
--
-- Name: state_pk; Type: CONSTRAINT; Schema: ivela; Owner: ivela; Tablespace: 
--
...
--
-- Name: country_state_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY state
    ADD CONSTRAINT country_state_fk FOREIGN KEY (country) REFERENCES country(id);
...
--
-- Name: ethnicity_profile_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY profile
    ADD CONSTRAINT ethnicity_profile_fk FOREIGN KEY (ethnicity) REFERENCES ethnicity(id);
...
--
-- Name: honorific_profile_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY profile
    ADD CONSTRAINT honorific_profile_fk FOREIGN KEY (honorific) REFERENCES honorific(id);


--
-- Name: language_internationalization_profile_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY profile
    ADD CONSTRAINT language_internationalization_profile_fk FOREIGN KEY (language) REFERENCES language_internationalization(id);


--
-- Name: language_language_internationalization_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY language_internationalization
    ADD CONSTRAINT language_language_internationalization_fk FOREIGN KEY (language) REFERENCES language(id);
...
--
-- Name: location_type_address_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY address
    ADD CONSTRAINT location_type_address_fk FOREIGN KEY (location_type) REFERENCES location_type(id);
...
--
-- Name: state_address_fk; Type: FK CONSTRAINT; Schema: ivela; Owner: ivela
--

ALTER TABLE ONLY address
    ADD CONSTRAINT state_address_fk FOREIGN KEY (state) REFERENCES state(id);
